...
import { TrendingUp, Plus, Scale, Ruler, Camera, Dumbbell } from "lucide-react";
import { FadeIn } from "@/components/ui/animate";
import { toast } from "sonner";
import dynamic from "next/dynamic";

const ProgressCharts = dynamic(() => import("./_components/progress-charts"), { ssr: false, loading: () => <div className="h-64 bg-muted animate-pulse rounded-lg" /> });
