      ...
      {stats && (
        <FadeIn delay={0.5}>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            <Card><CardContent className="p-3 text-center"><p className="text-xs text-muted-foreground">Avg Calories</p><p className="text-lg font-bold font-mono">{stats.avgCalories}</p><p className="text-[10px] text-muted-foreground">/ {stats.targetCal} kcal</p></CardContent></Card>
            <Card><CardContent className="p-3 text-center"><p className="text-xs text-muted-foreground">Avg Protein</p><p className="text-lg font-bold font-mono">{stats.avgProtein}g</p><p className="text-[10px] text-muted-foreground">/ {stats.targetProtein}g</p></CardContent></Card>
            <Card><CardContent className="p-3 text-center"><p className="text-xs text-muted-foreground">Avg Water</p><p className="text-lg font-bold font-mono">{Math.round(stats.avgWaterMl / 100) / 10}L</p><p className="text-[10px] text-muted-foreground">/ {Math.round(stats.targetWater / 1000 * 10) / 10}L</p></CardContent></Card>
            <Card><CardContent className="p-3 text-center"><p className="text-xs text-muted-foreground">Workouts</p><p className="text-lg font-bold font-mono">{stats.workoutCount}</p><p className="text-[10px] text-muted-foreground">sessions</p></CardContent></Card>
          </div>
        </FadeIn>
      )}
    </div>
